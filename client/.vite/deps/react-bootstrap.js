import {
  ...
  require_warning,
  useCol
} from "./chunk-IYSBHBRS.js";
import {
  Button_default as Button_default2
} from "./chunk-7GEBQIPZ.js";
import {
  ButtonGroup_default
} from "./chunk-7YAQ7COO.js";
import {
...
var context3 = React16.createContext(null);
...
var SelectableContext = React33.createContext(null);
...
var NavContext = React34.createContext(null);
...
var InputGroupCheckbox = (props) => (0, import_jsx_runtime47.jsx)(InputGroupText_default, {
  children: (0, import_jsx_runtime47.jsx)(FormCheckInput_default, {
    type: "checkbox",
    ...props
  })
});
var InputGroupRadio = (props) => (0, import_jsx_runtime47.jsx)(InputGroupText_default, {
  children: (0, import_jsx_runtime47.jsx)(FormCheckInput_default, {
    type: "radio",
    ...props
  })
...
var TabContext = React54.createContext(null);
...
function useNavItem({
  ...
  const parentOnSelect = (0, import_react29.useContext)(SelectableContext_default);
  const navContext = (0, import_react29.useContext)(NavContext_default);
  const tabContext = (0, import_react29.useContext)(TabContext_default);
  let isActive = active;
  const props = {
    role
  };
...
var NavItem = React55.forwardRef((_ref, ref) => {
  let {
    as: Component2 = Button_default,
    active,
    eventKey
...
var Nav = React56.forwardRef((_ref, ref) => {
  let {
    // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
    as: Component2 = "div",
    onSelect,
  ...
  const forceUpdate = useForceUpdate();
  const needsRefocusRef = (0, import_react30.useRef)(false);
  ...
  const listNode = (0, import_react30.useRef)(null);
...
var ListGroupItem = React57.forwardRef(({
  bsPrefix,
  active,
  disabled,
  eventKey,
...
var ListGroup = React58.forwardRef((props, ref) => {
  const {
    className,
...
function useRTGTransitionProps(_ref) {
  ...
  const handleEnter = (0, import_react33.useCallback)(normalize(onEnter), [onEnter]);
  const handleEntering = (0, import_react33.useCallback)(normalize(onEntering), [onEntering]);
  const handleEntered = (0, import_react33.useCallback)(normalize(onEntered), [onEntered]);
  const handleExit = (0, import_react33.useCallback)(normalize(onExit), [onExit]);
  const handleExiting = (0, import_react33.useCallback)(normalize(onExiting), [onExiting]);
  const handleExited = (0, import_react33.useCallback)(normalize(onExited), [onExited]);
  const handleAddEndListener = (0, import_react33.useCallback)(normalize(addEndListener), [addEndListener]);
  return Object.assign({}, props, {
    ...
    ) : (0, import_react33.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
var RTGTransition = React59.forwardRef((_ref, ref) => {
  let {
    component: Component2
  } = _ref, props = _objectWithoutPropertiesLoose7(_ref, _excluded7);
  const transitionProps = useRTGTransitionProps(props);
  return (0, import_jsx_runtime52.jsx)(Component2, Object.assign({
    ref
  }, transitionProps));
});
...
function useTransition({
  ...
  const isInitialRef = (0, import_react34.useRef)(true);
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react34.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default(ref, children.ref);
  return exited && !inProp ? null : (0, import_react34.cloneElement)(children, {
    ref: combinedRef
  });
}
function renderTransition(component, runTransition, props) {
  if (component) {
    return (0, import_jsx_runtime53.jsx)(RTGTransition_default, Object.assign({}, props, {
      component
    }));
  }
  if (runTransition) {
...
function useModalManager(provided) {
  ...
  const modal = (0, import_react35.useRef)({
    dialog: null,
    backdrop: null
  });
  return Object.assign(modal.current, {
    ...
    setDialogRef: (0, import_react35.useCallback)((ref) => {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: (0, import_react35.useCallback)((ref) => {
      modal.current.backdrop = ref;
    }, [])
  });
}
var Modal = (0, import_react35.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
  ...
  const [exited, setExited] = (0, import_react35.useState)(!show);
  const lastFocusRef = (0, import_react35.useRef)(null);
  (0, import_react35.useImperativeHandle)(ref, () => modal, [modal]);
  ...
  const removeFocusListenerRef = (0, import_react35.useRef)();
  const removeKeydownListenerRef = (0, import_react35.useRef)();
  ...
  return (0, import_jsx_runtime54.jsx)(import_jsx_runtime54.Fragment, {
    children: import_react_dom.default.createPortal((0, import_jsx_runtime54.jsxs)(import_jsx_runtime54.Fragment, {
...
var ModalBody = React62.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ModalContext = React63.createContext({
...
var ModalDialog = React64.forwardRef(({
  bsPrefix,
  className,
  contentClassName,
  centered,
...
var ModalFooter = React65.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var AbstractModalHeader = React66.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
  ...
  const context6 = (0, import_react36.useContext)(ModalContext_default);
...
var ModalHeader = React67.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var ModalTitle = React68.forwardRef(({
  className,
  bsPrefix,
...
var Modal2 = React69.forwardRef(({
  ...
  const [modalStyle, setStyle] = (0, import_react37.useState)({});
  const [animateStaticModal, setAnimateStaticModal] = (0, import_react37.useState)(false);
  const waitingForMouseUpRef = (0, import_react37.useRef)(false);
  const ignoreBackdropClickRef = (0, import_react37.useRef)(false);
  const removeStaticModalAnimationRef = (0, import_react37.useRef)(null);
  ...
  const renderBackdrop = (0, import_react37.useCallback)((backdropProps) => (0, import_jsx_runtime62.jsx)("div", {
    ...backdropProps,
...
var NavItem2 = React70.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Nav2 = React72.forwardRef((uncontrolledProps, ref) => {
  ...
  let isNavbar = false;
  const navbarContext = (0, import_react38.useContext)(NavbarContext_default);
  const cardHeaderContext = (0, import_react38.useContext)(CardHeaderContext_default);
  if (navbarContext) {
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react41.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react42.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var OffcanvasBody = React76.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OffcanvasTitle = React79.forwardRef(({
  className,
  bsPrefix,
...
var Offcanvas = React80.forwardRef(({
  ...
  const modalManager = (0, import_react43.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const [showOffcanvas, setShowOffcanvas] = (0, import_react43.useState)(false);
  const handleHide = useEventCallback(onHide);
  ...
  const renderBackdrop = (0, import_react43.useCallback)((backdropProps) => (0, import_jsx_runtime73.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React81.forwardRef(({
  onHide,
  ...props
}, ref) => {
...
var NavbarText = React82.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime90.jsxs)(import_jsx_runtime89.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react50.cloneElement)(children, triggerProps), (0, import_jsx_runtime88.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
function useTabPanel(_ref) {
  ...
  const context6 = (0, import_react52.useContext)(TabContext_default);
...
var ToastFade = React110.forwardRef((props, ref) => (0, import_jsx_runtime111.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React112.forwardRef(({
  ...
  const context6 = (0, import_react54.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
